...
happyExpList = Happy_Data_Array.listArray (0,35) ([9344,4672,64,64,0,292,146,0,32768,8200,36873,32772,0,37376,0,0,0,128,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","Expression","Disjunction","Conjunction","Negative","NOT","OR","AND","LEFT","RIGHT","IMPLICATION","VARIABLE","%eof"]
        bit_start = st * 15
        bit_end = (st + 1) * 15
...
happyReduction_2 (HappyAbsSyn4  happy_var_3)
	...
	(HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn4
		 (Calc Impl happy_var_1 happy_var_3
	)
...
happyReduction_4 (HappyAbsSyn6  happy_var_3)
	...
	(HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn5
		 (Calc Or happy_var_1 happy_var_3
	)
...
happyReduction_6 (HappyAbsSyn7  happy_var_3)
	...
	(HappyAbsSyn6  happy_var_1)
	 =  HappyAbsSyn6
		 (Calc And happy_var_1 happy_var_3
	)
...
happyReduction_8 (HappyTerminal (TokenVariable happy_var_1))
	 =  HappyAbsSyn7
		 (Var happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenOr -> cont 9;
	TokenAnd -> cont 10;
	TokenLeftBracket -> cont 11;
	TokenRightBracket -> cont 12;
	TokenImplication -> cont 13;
	TokenVariable happy_dollar_dollar -> cont 14;
	_ -> happyError' ((tk:tks), [])
	}
